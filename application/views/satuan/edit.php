...
<?php echo $message;?>
	<div class="form-group">
		...
		<div class="col-lg-3">
			<input type="text" readonly="readonly" value="<?php echo $satuan['id_satuan'];?>" class="form-control" name="id" required="required">
		</div>
	...
	<div class="form-group">
		...
		<div class="col-lg-3">
			<input type="text" value="<?php echo $satuan['nm_satuan'];?>" class="form-control" name="nama" required="required">
		</div>
